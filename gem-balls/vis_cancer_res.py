...
sns.distplot(boosted.values[:,1], bins=30, hist=False, label="Boosted")
...
sns.distplot(boosted.values[:,0], bins=30, hist=False, label="Boosted")
...
print("Mean boosted acc: {}".format(np.mean(boosted.values[:,2])))
plt.show()